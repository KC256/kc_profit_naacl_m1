...
embedding_size = 4096 #384

folder_path = "/home/fukuda/M1_reserch/datasets/test_data_sorted_in_jsons_6" #pickleファイル作成の対象となるフォルダ json
...
def make_pickle(date_start, date_end):
    ...
    while(date_target_object != date_end_object + timedelta(days=1)):
        ...
        if(j-lookback_length+1>0):
            ...
            print("torch.tensor(embedding_list).shape:", torch.tensor(embedding_list).shape)
