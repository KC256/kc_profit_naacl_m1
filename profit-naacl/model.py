...
class Actor(nn.Module):
    ...
    def forward(self, state):
        # print("before_state.shape", state.shape)
        ...
        for i in range(self.num_stocks):
            ...
            # print(i, "lstm1_out", lstm1_out) #ここNanだけではない
            ...
            x = self.linearx2[i](x)
            text_out[i] = x
            # print(i, "text_out[i]", text_out[i]) #lstm1_outに一つでもNanが含まれているとこれがNanになる　tweetがない日を詰めてないのが本来の仕様と違う
