...
class StockEnvTrade(gym.Env):
    ...
    def step(self, actions):
        ...
        if self.terminal:
            ...
            # print("df_total_value_1 ", df_total_value) #まだnanはない
            ...
            df_total_value["daily_return"] = df_total_value.pct_change(1) #ここでnan発生
            # print("df_total_value:", df_total_value) #ここでdf_total_value["daily_return"]がnanになってる
            ...
            # print("argsort_actions.shape ", argsort_actions.shape)
