...
class DDPG(object):
    def __init__(self, nb_states, nb_actions, args):
        ...
        elif USING_MODEL=="model_6": # この行を追加
            from model_6 import Actor, Critic # この行を追加
        
        elif USING_MODEL=="model_7": # この行を追加
            from model_7 import Actor, Critic # この行を追加
        
        elif USING_MODEL=="model_8": # この行を追加
            from model_8 import Actor, Critic # この行を追加
            
        elif USING_MODEL=="model_9": # この行を追加
            from model_9 import Actor, Critic # この行を追加
            
        elif USING_MODEL=="model_10": # この行を追加
            from model_10 import Actor, Critic # この行を追加
            
        elif USING_MODEL=="model_11": # この行を追加
            from model_11 import Actor, Critic # この行を追加
    ...
    def save_model_bysteps(self, output, step):
        try:
            ...
            print("success saving model to ", folder_path)
