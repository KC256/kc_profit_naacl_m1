    ...
    def __call__(self, env, policy, debug=False, visualize=False, save=True):
        ...
        for episode in range(self.num_episodes):
            ...
            while not done:
                ...
                observation, reward, done, info = env.step(action) #ここで本来terminalの情報が入るはずだが入っていない？
                # print("info: ", info)
                if (
        ...
        # print("eva sharpe:", sharpe) #値そのものが入ってないからNanになる
        # print("eva result ", result)
