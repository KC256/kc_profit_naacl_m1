# model_15 : SMLT-FRS-G(stock only) 株価のみマルチ粒度
import torch
...
class Actor(nn.Module):
    ...
    def __init__(
        ...
        self.price_merge_linear_2 = nn.Linear(32, 16)
    ...
    def forward(self, state):
        ...
        pre_price_out = self.price_merge_linear(concatenated_price)
        concatenated_price_2 = torch.cat([pre_price_out, price_out_G1], dim=2)
        price_out = self.price_merge_linear_2(concatenated_price_2)
        ...
        text_out = text_out_G1 #テキストは粒度１のみ
        text_out = text_out.view(self.bs, -1)
