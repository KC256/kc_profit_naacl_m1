# model_5: Processes price_history with LSTM and Linear layers before fusion.
...
class Actor(nn.Module):
    ...
    def __init__(
        ...
        # ★★★ 最終結合層の入力次元を更新 ★★★
        # 元の入力: 64 * num_stocks (text) + 64 * num_stocks (sec) + 32 (stock_feats) = 2592
        # 新しい入力: 2592 + 16 * num_stocks (price_feats)
        final_input_dims = (64 * num_stocks) + (64 * num_stocks) + 32 + (16 * num_stocks)
    ...
    def forward(self, state):
        ...
        print("price_out.shape:", price_out.shape)
        ...
        print("after price_out.shape:", price_out.shape)
