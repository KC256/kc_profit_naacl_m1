# model_9: model8 の　mhattnのinputをtorch.stackではなく直列concatしたものに置き換え
import torch
...
class Actor(nn.Module):
    ...
    def forward(self, state):
        ...
        price_out_flat = price_out.permute(1, 0, 2).view(self.bs, -1)
        ...
        attn_input = torch.stack([proj_x_stock, proj_text_out, proj_text_out_2, proj_price_out], dim=1)
