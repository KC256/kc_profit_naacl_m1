# model_11 : model_10時点ではなかった　 'dates_2', 'date_last_2', 'embedding_2', 'length_data_2', 'time_features_2']に対応　構造も変更 SMRT-FRS-attn-G
import torch
...
class Actor(nn.Module):
    ...
    def _process_data_2(self, state):
        ...
        if INPUT_TEXT=="tweetonly":
            ...
            time_feats = state[:,
                            TIME2_IDX:].view(-1, self.num_stocks, N_DAYS, MAX_TWEETS)
